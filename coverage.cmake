...
function(add_coverage_targets executable run-target prefix source-dir)
    ...
    if (ARGV7)
        set(exclude_string ${exclude_string} -e ${ARGV7})
    endif()
    if (ARGV8)
        set(exclude_string ${exclude_string} -e ${ARGV8})
    endif()
    if (ARGV9)
        set(exclude_string ${exclude_string} -e ${ARGV9})
    endif()
    if (ARGV10)
        set(exclude_string ${exclude_string} -e ${ARGV10})
    endif()
